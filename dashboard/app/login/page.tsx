...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // Skip auth for now — just redirect to dashboard
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-bg-main to-bg-card">
      <div className="w-full max-w-md p-8 bg-bg-card/80 backdrop-blur-md border border-bg-border rounded-2xl">
        <h1 className="text-2xl font-display font-700 text-white mb-4">Sign in</h1>
        ...
        >
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
            ...
            <path d="M12.17 22c2.94 0 5.4-.95 7.2-2.58l-3.51-2.6c-.98.66-2.23 1.04-3.69 1.04-2.84 0-5.25-1.92-6.1-4.52H2.46v2.83C4.26 19.98 8.75 22 12.17 22z" fill="#34A853"/>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          {message && (
            <div className={`text-sm p-3 rounded-lg ${
              message.includes("failed") || message.includes("Sign in failed")
          ...
          <div className="text-sm text-gray-400 pt-2">
            Don't have an account? <a href="/signup" className="text-accent-cyan underline">Sign up</a>
          </div>
        </form>
      </div>
    </div>
